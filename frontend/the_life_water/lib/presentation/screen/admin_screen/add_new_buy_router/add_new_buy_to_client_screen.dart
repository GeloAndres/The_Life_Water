...
class _FormNewOrder extends StatefulWidget {
  @override
  State<_FormNewOrder> createState() => _FormNewOrderState();
}

class _FormNewOrderState extends State<_FormNewOrder> {
        ...
        child: Column(
          children: [
            FormBuilderTextField(
              ...
              name: 'nombre',
              decoration: decorationFormOrder(
            ...
            FormBuilderTextField(
              name: 'numero',
              decoration: decorationFormOrder(
                  'Numero Celular', Icons.phone, '912345678'),
              validator: FormBuilderValidators.compose([
                FormBuilderValidators.required(
            ...
            FormBuilderTextField(
              name: 'sector',
              decoration:
                  decorationFormOrder('Sector', Icons.maps_home_work, 'Maipu'),
              validator: FormBuilderValidators.compose([
                FormBuilderValidators.required(
                    errorText: 'Nombre es requerido'),
                FormBuilderValidators.minLength(3,
